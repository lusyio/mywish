...
const WishItem = props => {
    ...
    let widgetWish =
        <WishWidget>
            <Button type='widget'><img src={pencil}/></Button>
        ...
        renderWishItem =
            <React.Fragment>
                <div className={classes.WishItem}>
                    ...
                    <div>
                        <Input placeholder='Название желания, н-р: Apple iPhone XS ' maxLength='100' onChange={event => props.onChangeWishName(event)}/>
                        <Input placeholder='Ссылка на товар, н-р: https://apple.com/ru/' maxLength='255' onChange={event => props.onChangeWishUrl(event)}/>
                    </div>
                    {widgetAddNew}
                </div>
            </React.Fragment>
